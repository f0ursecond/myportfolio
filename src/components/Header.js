    ...
    <div className='w-full h-screen p-2 text-center '>
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        ...
        <div>
          ...
          <h1 className='text-base lg:text-4xl text-white font-poppins font-bold -tracking-tighter px-4'>Hi,I'm <span className='text-[#eebbc3]'>Alif Zulfanur</span></h1>
          <div className='flex text-center justify-center'>
            <h1 className='text-base lg:text-4xl text-white font-poppins font-bold -tracking-tighter px-2'>I want to be</h1>
            <Typed className='text-base lg:text-4xl text-[#eebbc3] font-poppins font-bold -tracking-tighter ' strings={[
              'Mobile Developer',
              'Front-End Developer',
              'Flutter Developer',
              'Cyber Security'
