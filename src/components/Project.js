...
function Project() {
  let projects = [
    ...
    },
    {
      ...
      description: "Projek Aplikasi Android yaitu membuat AL Quran App, ini sebenarnya belom 100% jadi karena saya hanya mencoba untuk fetch API dari internet saja",
      image: card,
      tag: "Flutter",
    },
    {
      ...
      description: "Projek Aplikasi Android membuat page login dengan memadukan authentication menggunakan Firebase",
      image: card,
      tag: "Flutter",
    },
    {
      ...
      description: "Projek Website sekolah membuat smart cafe, menggunakan php native dan Tailwind CSS",
      image: card,
    ...
    },
    {
      ...
      description: "Projek Aplikasi login sederhana, hanya menggunakan if else saja , karena ini pertama kali saya menggunakan android studio dan java",
      image: card,
    ...
    },
    {
      ...
      description: "Projek restapi sederhana, untuk sekadar penasaran bagaimana sebenarnya api bisa terbuat",
      image: card,
                ...
                <div class="max-w-sm  p-2 rounded overflow-hidden shadow-lg  bg-white">
                  ...
                  <div class="px-6 py-4">
                    <div class="font-bold text-xl mb-2">
                      <a className="hover:text-sky-500" href={e.link} target="blank">{ e.name }</a>
                    </div>
